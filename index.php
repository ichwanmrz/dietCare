        ...
        <nav class="navbar navbar-expand-lg navbar-light p-4 ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#health">Kesehatan Ginjal</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="carousel-item active">
                    <div class="banner_section">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <h1 class="banner_title">DIET<span style="color: #151515;">Care</span></h1>
                                ...
                                <div class="col-md-6">
                                    <div class="image_1"><img src="images/img-1-1.png"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="banner_section">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="image_1"><img src="images/img-1-2.png"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="map_icon"><img src="images/map-icon.png"><span class="paddlin_left_0">Page when looking
                            at its</span></div>
                    <div class="map_icon"><img src="images/call-icon.png"><span class="paddlin_left_0">+878787876</span>
                    </div>
